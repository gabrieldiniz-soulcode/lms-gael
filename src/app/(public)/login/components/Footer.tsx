export default function Footer() {
    ...
    return (
        <footer className="d-flex justify-content-center gap-5 flex-wrap w-100 bg-auxiliary1-project px-2 py-4">
            <span className="text-white text-center  px-md-0 px-5 fs-20">©2015-{currentYear} SoulCode. Todos os direitos reservados.</span>
